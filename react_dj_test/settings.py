"""
Django settings for react_dj_test project.
...
SECRET_KEY = 'django-insecure-fd(vm@_vobqp-8nk+an3b23jb7lbkaoqd-rdpty_*tuwd=tnee'
...
WSGI_APPLICATION = 'react_dj_test.wsgi.application'
